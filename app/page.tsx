...
export default function Home() {
  ...
  return (
    <div
      className={`flex flex-col items-center px-4 sm:px-16 pb-1 h-screen gap-2 bg-hero2 bg-no-repeat w-full bg-cover ${roboto_mono.className}`}
    >
      <Navbar />
      <div className="flex-1 flex flex-col justify-center items-center w-full md:mt-32">
